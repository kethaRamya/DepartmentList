...
export function UpdateModalForm(props) {
  ...
  const OnHandleClick = () => {
    ...
    let formData = { "dId": props.id, "name": update }
    ...
    <>
      ...
      <Modal show={show} onHide={handleClose}>
        ...
        <Modal.Body>
          ...
          <input type="text" placeholder="Update the post" onChange={(event) => { setUpdate(event.target.value) }} class="input_st" />
        </Modal.Body>
        <Modal.Footer>
